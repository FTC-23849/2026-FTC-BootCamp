...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1752.0407086544412; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 644.47891211844; // x position of the perpendicular encoder (in tick units)
    }
